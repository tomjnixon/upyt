...
class TestConnectionFromSpecification:
    ...
    def test_serial_default_baudrate(self, name: str, mock_serial_connection: Mock) -> None:
    ...
    @pytest.mark.parametrize("name", ["COM2", "/dev/ttyACM3", "/dev/ttyACM:with:colons:in"])
    def test_serial_custom_baudrate(self, name: str, mock_serial_connection: Mock) -> None:
